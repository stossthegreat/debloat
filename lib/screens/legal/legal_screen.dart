...
LegalDoc get termsDoc => LegalDoc(
  title: 'Terms of Use',
  subtitle: 'DEBLOAT · THE AGREEMENT',
  ...
  sections: [
    ...
    LegalSection('DEBLOAT PRO — WHAT YOU GET, PRICE & AUTO-RENEWAL',
      'Debloat Pro is a single auto-renewing weekly subscription. This is '
    ...
    const LegalSection('ABOUT DEBLOAT',
      'Debloat OS is a self-assessment and self-improvement tool for '
      'cosmetic and grooming decisions. It uses on-device '
      ...
      'grooming changes applied to your photo. '
      'Debloat OS is not a medical device and does not provide '
      'medical, dental, psychological, or surgical advice.'),
    const LegalSection('WHO CAN USE THIS APP',
      'You must be at least 13 years old to use Debloat OS. If you are '
    ...
    LegalSection('ACCOUNTS',
      'Debloat OS does not require an account. Purchases and saved '
    ...
    const LegalSection('WHAT WE RENDER — AND WHAT WE DO NOT',
      ...
      'barber, surgeon, or dermatologist. Never use an Debloat OS '
    ...
    const LegalSection('YOUR CONTENT',
      'You retain all rights to photos you take inside Debloat OS. By '
      'scanning a photo and granting in-app permission in the AI data '
      'consent dialog, you grant Debloat OS a limited, revocable, '
    ...
    const LegalSection('AI DATA PERMISSION — EVERY DETAIL OF WHAT GETS SENT, WHERE, AND WHY',
      ...
      'device, Debloat OS displays a full-screen permission dialog '
      ...
      'Step 2 — Debloat OS\'s backend → AI provider:\n'
      ...
      '• On Debloat OS\'s backend: bytes not persisted; only '
    ...
    const LegalSection('FACE DATA — WHAT WE COLLECT, WHY, WHO RECEIVES IT, HOW LONG WE KEEP IT',
      'WHAT FACE DATA DEBLOAT COLLECTS\n\n'
      'Debloat OS collects two related pieces of face data:\n'
      ...
      'identify you.\n\n'
      'HOW DEBLOAT USES FACE DATA\n\n'
      '• Compute and display your bloat-zone readings and debloat '
      'score on screen, on-device.\n'
      ...
      'Debloat OS does NOT use face data for: facial recognition, '
      ...
      '• On Debloat OS servers — request timestamps and status codes '
      ...
      'On Debloat OS\'s servers: never retained.\n'
    ...
    const LegalSection('THIRD-PARTY PROTECTION PARITY',
      ...
      'receives Debloat OS user data must provide the same or equal '
      'privacy protection as Debloat OS itself. Both providers we '
    ...
    const LegalSection('ACCEPTABLE USE',
      ...
      'consent. You agree not to use Debloat OS '
    ...
    const LegalSection('DISCLAIMERS & LIABILITY',
      'Debloat OS is provided "as is" without warranty of any kind, '
      'express or implied. To the maximum extent permitted by law, '
      'Debloat OS\'s total liability for any claim is limited to the '
      'amount you paid Debloat OS in the twelve months preceding the '
      'claim.'),
...
LegalDoc get privacyDoc => LegalDoc(
  ...
  sections: [
    ...
    const LegalSection('FACE DATA — QUICK SUMMARY',
      ...
      'call, then dropped. Neither Debloat OS nor the third parties we '
      ...
      '• On Debloat OS\'s own backend: never persisted. The backend acts '
      ...
      'numbers, not a biometric template.\n\n'
    ...
    const LegalSection('THE SHORT VERSION',
      ...
      'your chats. We do not require an account. You can '
    ...
    const LegalSection('AI DATA PERMISSION — EVERY DETAIL',
      ...
      '• Debloat OS\'s own backend (Railway), transient routing.\n'
      'No other party.\n\n'
      'RETENTION\n\n'
      '• On your phone: until you delete or uninstall.\n'
      '• In flight: TLS 1.3 encrypted.\n'
      '• Debloat OS backend: bytes not persisted; only timestamps '
    ...
    const LegalSection('FACE DATA — WHAT IT IS, WHAT IT ISN\'T',
      ...
      'Debloat OS server.\n'
      '• No model training. Neither Debloat OS nor any third party we '
    ...
    const LegalSection('THIRD-PARTY PROTECTION PARITY',
      'Per App Store guideline 5.1.2(i), any third party that '
      'receives Debloat OS user data must provide the same or equal '
      'privacy protection as Debloat OS itself. Both AI providers '
      'meet this bar:\n\n'
      '• OpenAI — under the standard API terms, customer inputs are '
    ...
    const LegalSection('CHILDREN',
      'Debloat OS is not intended for children under 13. We do not '
    ...
    LegalSection('PURCHASES',
      ...
      '($_storeName). Debloat OS never sees your card number. We see '
