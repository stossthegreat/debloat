...
/// important man… we need it man." The dialog fires the moment a
/// user completes their first scan. Still one prompt per device.
///
...
class ReviewPromptService {
  ...
  /// Fire the prompt if the scan milestone has been hit and we haven't
  /// asked this device yet. Safe to call from anywhere — if the pref
  /// was already flipped or no milestone is yet ticked, it's a no-op.
